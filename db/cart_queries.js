...
const updateTotalProductCost = "UPDATE carts_products SET total_products_price = (quantity * (SELECT price FROM products WHERE id = $1)) WHERE product_id = $1";

const calculateTotal = "SELECT SUM(total_product_price) FROM carts_products WHERE cart_id = $1";
